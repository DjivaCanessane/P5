...
class ArithmeticsTestCase: XCTestCase {
    ...
    var arithmeticsDelegateMock = ArithmeticsDelegateMock()
    ...
    func testGivenCalculation_WhenSubstraction_ThenShowResult() {
        ...
        XCTAssertEqual(arithmeticsDelegateMock.mockCalculation, "1")
    }

    func testGivenCalculation_WhenAddition_ThenShowResult() {
        addCalculation("3 + 2")
        arithmetics.calculate()
        XCTAssertEqual(arithmeticsDelegateMock.mockCalculation, "5")
    }

    func testGivenCalculation_WhenMultiplication_ThenShowResult() {
        addCalculation("3 × 2")
        arithmetics.calculate()
        XCTAssertEqual(arithmeticsDelegateMock.mockCalculation, "6")
    }

    func testGivenCalculation_WhenDivision_ThenShowResult() {
        addCalculation("4 ÷ 2")
        arithmetics.calculate()
        XCTAssertEqual(arithmeticsDelegateMock.mockCalculation, "2")
    }

    func testGivenCalculation_WhenUsingAnotherOperand_ThenShowError() {
        addCalculation("4 / 5")
        arithmetics.calculate()
        XCTAssertEqual(arithmeticsDelegateMock.mockCalculation, "error")
    }
    // MARK: - Test Errors
    func testGivenCalculation_WhenDivisionByZero_ThenShowError() {
        addCalculation("4 ÷ 0")
        arithmetics.calculate()
        XCTAssertEqual(arithmeticsDelegateMock.mockCalculation, "impossible")
    }

    func testGivenZero_WhenAddingAnotherOperand_ThenZero() {
        addCalculation("/")
        XCTAssertEqual(arithmeticsDelegateMock.mockCalculation, "Unknown operand !")
    }
    ...
    func testGivenCalculationWithMultipleOperand_WhenCalculate_ThenCalculateWithPrioritizingMultiplication() {
        ...
        arithmetics.calculate()
        XCTAssertEqual(arithmeticsDelegateMock.mockCalculation, "15")
    }
    ...
    func testGivenCalculation_WhenStartingWithMinus_ThenShowError() {
        addCalculation(" + 4 + 3")
        arithmetics.calculate()
        XCTAssertEqual(arithmeticsDelegateMock.mockCalculation, "7")
    }
    ...
    func testGivenCalculationEndingWithInt_WhenDeleteElement_ThenCalculationWithoutLastElement() {
        addCalculation("3 + 5")
        arithmetics.delete()
        XCTAssertEqual(arithmeticsDelegateMock.mockCalculation, "3 + ")
    }
    ...
    func testGivenNothing_WhenDeleteElement_ThenKeepZero() {
        arithmetics.delete()
        XCTAssertEqual(arithmeticsDelegateMock.mockCalculation, "0")
    }
    ...
    func testGivenNilElement_WhenDelete_ThenReturnNil() {
        arithmeticsDelegateMock.mockCalculation = ""
        arithmetics.delete()
        XCTAssertEqual(arithmeticsDelegateMock.mockCalculation, "")
    }
    ...
    func testGivenCalculationEndingWithOperand_WhenAddOperand_ThenChangeOldOperandWithNewOperand() {
        addCalculation("45 + ")
        addCalculation("-")
        XCTAssertEqual(arithmeticsDelegateMock.mockCalculation, "45 - ")
    }
    ...
    override func setUp() {
        super.setUp()
        arithmetics.resetCalculation()
        arithmetics.calculationDelegate = arithmeticsDelegateMock
    }
